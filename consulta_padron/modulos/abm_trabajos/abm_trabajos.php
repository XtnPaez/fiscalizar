...
// --- Listar trabajos ---
$stmt     = $pdo->prepare("SELECT * FROM trabajos $where_q ORDER BY nombre ASC");
...
<div class="d-flex justify-content-between align-items-center mb-3">
    <div class="modulo-titulo mb-0">Trabajos</div>
...
<form method="GET" action="index.php" class="mb-3">
    <input type="hidden" name="mod" value="abm_trabajos">
    <div class="row g-2 align-items-center">
        ...
        <?php if ($busqueda !== ''): ?>
        <div class="col-auto">
            <a href="index.php?mod=abm_trabajos" class="btn btn-outline-secondary btn-sm">Limpiar</a>
        </div>
        <?php endif; ?>
    </div>
</form>
    ...
    <table class="table table-hover table-bordered align-middle">
        ...
        <tbody>
            ...
            <tr class="<?php echo !$t['activo'] ? 'text-secondary' : ''; ?>">
                ...
                <td>
                    <span class="badge"
                        style="background-color:<?php echo $t['activo'] ? '#a6d900' : '#6c757d'; ?>;
                               color:<?php echo $t['activo'] ? '#1a1a2e' : '#fff'; ?>;">
