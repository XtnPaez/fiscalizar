...
$stmt    = $pdo->query("SELECT * FROM partidos ORDER BY nombre ASC");
$partidos = $stmt->fetchAll();

require_once 'includes/navbar.php';
?>

<div class="modulo-titulo">Partidos</div>
    ...
    <table class="table table-hover table-bordered align-middle">
        ...
        <tbody>
            ...
            <tr class="<?php echo !$p['activo'] ? 'text-secondary' : ''; ?>">
                ...
                <td>
                    <span class="badge" style="background-color:<?php echo $p['activo'] ? '#a6d900' : '#6c757d'; ?>;color:<?php echo $p['activo'] ? '#1a1a2e' : '#fff'; ?>;">
                ...
                <td>
                    ...
                    <form method="POST" action="index.php?mod=abm_partidos" class="d-inline">
